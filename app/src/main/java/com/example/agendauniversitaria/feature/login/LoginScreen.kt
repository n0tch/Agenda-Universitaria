...
import com.example.agendauniversitaria.R
...
import com.example.agendauniversitaria.domain.model.LoginSocialEnum.ANONYMOUS
import com.example.agendauniversitaria.domain.model.LoginSocialEnum.FACEBOOK
import com.example.agendauniversitaria.domain.model.LoginSocialEnum.GOOGLE
import com.example.agendauniversitaria.ui.theme.LightBlue
import com.example.agendauniversitaria.ui.theme.White
...
fun LoginScreen(
    ...
    onLoginWithSocial: (LoginSocial) -> Unit = {},
...
@Composable
fun LoginSocial(onLoginWithSocial: (LoginSocial) -> Unit) {
    Column {
        Text(
            modifier = Modifier.fillMaxWidth(),
            text = "Or Login with",
        ...
        Row(
            ...
            OutlinedButton(
                onClick = { onLoginWithSocial(LoginSocial(GOOGLE)) }
            ) {
                Icon(imageVector = Icons.Filled.Star, contentDescription = "")
            }
            OutlinedButton(
                modifier = Modifier.padding(horizontal = 12.dp),
                onClick = { onLoginWithSocial(LoginSocial(FACEBOOK)) }) {
                Icon(imageVector = Icons.Filled.Train, contentDescription = "")
            }
            OutlinedButton(onClick = { onLoginWithSocial(LoginSocial(ANONYMOUS)) }) {
